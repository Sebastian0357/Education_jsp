...
//		}
		...
		User u = new User(usernow.getUname(), usernow.getPwd(), gender, email, introduce, birthday, organization, phone,null);		
		UserDao uDao = new UserDao();
		if(uDao.updateUserInfo(u) != null)
		{
			//修改成功，自动查询修改后的结果
			System.out.println("修改成功");
			session.setAttribute("user", uDao.updateUserInfo(u));
			url="self.jsp";
		}
		else {
			url="self.jsp";
