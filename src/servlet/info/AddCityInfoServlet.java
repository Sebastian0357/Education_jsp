...
/**
 * Servlet implementation class AddCityInfoServlet
 */
@WebServlet(name = "addCityInfoServlet", urlPatterns = { "/addCityInfoServlet" })
@MultipartConfig(maxFileSize = 10 * 1024 * 1024)
public class AddCityInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddCityInfoServlet() {
        super();
